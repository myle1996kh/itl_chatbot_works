...
-- Verification
-- ============================================================
SELECT '=== Base Data Seeding Summary ===' as status;
SELECT 'LLM Models' as entity, COUNT(*) as count FROM llm_models
UNION ALL
SELECT 'Output Formats' as entity, COUNT(*) as count FROM output_formats
UNION ALL
SELECT 'Base Tools' as entity, COUNT(*) as count FROM base_tools
UNION ALL
SELECT 'Tool Configs' as entity, COUNT(*) as count FROM tool_configs
UNION ALL
SELECT 'Agent Configs' as entity, COUNT(*) as count FROM agent_configs
UNION ALL
SELECT 'Agent-Tool Links' as entity, COUNT(*) as count FROM agent_tools;
