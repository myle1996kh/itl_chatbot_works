    ...
    <div className="flex flex-col h-full bg-white rounded-lg shadow-xl overflow-hidden font-sans">
      ...
      <div className="flex-1 p-6 flex flex-col justify-center">
        <div className="text-center mb-6">
          ...
          <h3 className="text-gray-800 font-semibold text-lg">Please introduce yourself</h3>
          <p className="text-gray-500 text-sm">To start chatting, we need a few details.</p>
        </div>
